...
const (
	DemoService_Ping_FullMethodName = "/external.demo.v1.DemoService/Ping"
)
...
//
// DemoService 表示一个外部 gRPC 服务示例。
// 当前项目只消费外部 gRPC 接口，不提供 gRPC server。
...
var DemoService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "external.demo.v1.DemoService",
	...
	Metadata: "proto/external/demo/v1/demo.proto",
}
